 ...
 */
final class Version20230429203417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE default_item ADD item_set_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE default_item ADD CONSTRAINT FK_5AEA1E18960278D7 FOREIGN KEY (item_set_id) REFERENCES item_set (id)');
        $this->addSql('CREATE INDEX IDX_5AEA1E18960278D7 ON default_item (item_set_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5AEA1E18960278D7 ON default_item');
        $this->addSql('ALTER TABLE default_item DROP item_set_id');
    }
}
